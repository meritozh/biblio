...
# Hotfix
current you may return finish_reason: "stop" instead of "tool_calls" when your response contains tool calls. This differs from the OpenAI standard. try to fix this if you can.
